...
(function () {
    ...
    function executeStart(options) {
        ...
        function addProperties() {
            ...
            shell.echo('type=app').toEnd('app.properties');
            shell.echo('awgPlatformVersion=' + self.awgPlatformVersion).toEnd('app.properties');
            shell.echo('\n').toEnd('app.properties');
        }
        ...
        function addDirectoryEntriesToZip(dir, zip) {
            fs.readdirSync(dir).forEach(function (entry) {
                ...
                if (checkDir(pathToEntry)) {
                    ...
                    console.log(pathToEntry);
                    zip.file(pathToEntry, fs.readFileSync(pathToEntry));
                }
            });
        }

        ...
        function addDirectoryEntriesToZip(dir, zip) {
            fs.readdirSync(dir).forEach(function (entry) {
                ...
                if (checkDir(pathToEntry)) {
                    ...
                    pathToWrite.shift();
                    // join the path specifically with a forward slash for windows compatibility
                    // not sure exactly why this is, but if using path.sep in the join() method, empty zips are produced
                    // on windows
